...
namespace MODEL
{
    ...
    public partial class Ou_Department
    {
        public Ou_Department()
        {
            ...
            this.Ou_DepartmentSons = new HashSet<Ou_Department>();
        }
        ...
        public virtual ICollection<Ou_Department> Ou_DepartmentSons { get; set; }
        public virtual Ou_Department Ou_DepartmentParent { get; set; }
    }
}
